...
import createToken from '../Utilis/createToken.js';
...
const updateCurrProfile=asyncHandler(async(req,res)=>{
  const user=await User.findById(req.user._id)
...
export {createUser,loginUser,logoutUser,getAllUsers,getCurrentUserProfile,updateCurrProfile,deleteUserById,getUserById,updateUserById};