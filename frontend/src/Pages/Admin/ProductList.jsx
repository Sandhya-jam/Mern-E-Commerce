            ...
            <div className="md:w-3/4 p-3">
              ...
              <div className="p-3">
                 <div className="flex flex-wrap">
                    ...
                    <div className="two ml-10 text-white">
                 ...
                 <label htmlFor="" className="my-5 text-white">Description</label>
                 ...
                 <div className="flex justify-between text-white">
                    <div>
                        <label htmlFor="name block">Count In</label> <br/>
                    ...
                    <div>
                        ...
                        <br/>
                        <select placeholder='Choose Category' className="p-4 mb-3 w-[30rem] border rounded-lg bg-[#101011] text-white" onChange={e=>setCategory(e.target.value)}>{categories?.map((c)=>(
