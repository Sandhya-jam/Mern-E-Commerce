        ...
        <div className="mr-[4rem] mt-[5rem]">
          ...
          className="container w-[40rem]">
            <div className="my-[2rem]">
              ...
              <input type="text" id="name" className="mt-1 p-2 border rounded w-full my-4"
              placeholder="Enter name" value={username} onChange={e=>setUsername(e.target.value)}
              />
              <label htmlFor="email" className="block text-sm font-medium text-white">
                Email
              </label>
              <input type="email" id="email" className="mt-1 p-2 border rounded w-full my-4"
              placeholder="Enter email" value={email} onChange={e=>setemail(e.target.value)}
              />
              <label htmlFor="password" className="block text-sm font-medium text-white">
                Password
              </label>
              <input type="password" id="password" className="mt-1 p-2 border rounded w-full my-4"
              placeholder="Enter password" value={password} onChange={e=>setpassword(e.target.value)}
              />
              <label htmlFor="confirmpassword" className="block text-sm font-medium text-white">
                Confirm Password
              </label>
              <input type="password" id="confirmpassword" className="mt-1 p-2 border rounded w-full my-4"
          ...
          <div className="mt-4">
            <p className="text-white">
              ...
              className="text-purple-500 hover:underline">Login</Link>
            </p>
          </div>
        </div>
